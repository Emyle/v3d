 ...
 */
 define([
  ...
  'text!VisualModuleDir/theoryTrainDis/theoryTrainDis.html'
], function (Vue, Axios, Api, BaseModule, RoundRectBar, html) {
  function TheoryTrainDis(config) {
  ...
  /* 模块初始化 */
  TheoryTrainDis.init = TheoryTrainDis;

  /* 模块渲染 */
  TheoryTrainDis.render = function(response, config){
    var _this = this;
